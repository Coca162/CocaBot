...
{
    public class ShortXP : BaseCommandModule
    {
        [Command("stats")]
        public async Task Statsall(CommandContext ctx, DiscordUser discordUser)
        {
        ...
        [Command("st")]
        public async Task Stsall(CommandContext ctx, DiscordUser discordUser)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                string discordName = discordUser.Username;
        ...
        [Command("stats")]
        public async Task Statsuser(CommandContext ctx)
        {
            if (ctx.User.Id != 470203136771096596)
            {
        ...
        [Command("st")]
        public async Task Stuser(CommandContext ctx)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                string discordName = ctx.Member.Username;
...
#pragma warning restore IDE0004
        ...
        [Command("x")]
        public async Task XAll(CommandContext ctx, DiscordUser discordUser)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                string discordName = discordUser.Username;
...
#pragma warning restore IDE0004
        ...
        [Command("xp")]
        public async Task XPUser(CommandContext ctx, [RemainingText] string Inputname)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                if (Inputname != null)
...
#pragma warning restore IDE0004
        ...
        [Command("x")]
        public async Task XUser(CommandContext ctx, [RemainingText] string Inputname)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                if (Inputname != null)
...
#pragma warning restore IDE0004
        ...
        /*
        [Command("lb")]
        public async Task LB(CommandContext ctx, int remove)
        {
            if (ctx.User.Id != 470203136771096596)
            {
        ...
        */
        [Command("lbloop")]
        public async Task LBLoop(CommandContext ctx)
        {
            if (ctx.User.Id != 470203136771096596)
            {
