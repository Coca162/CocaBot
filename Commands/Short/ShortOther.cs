...
{
    public class ShortOther : BaseCommandModule
    {
        [Command("s")]
        public async Task SUser(CommandContext ctx, DiscordUser discordUser)
        {
        ...
        [Command("s")]
        public async Task S(CommandContext ctx, [RemainingText] string Inputname)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                if (Inputname != null)
        ...
        [Command("n")]
        public async Task NUser(CommandContext ctx, DiscordUser discordUser)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                ulong discordID = discordUser.Id;
        ...
        [Command("n")]
        public async Task N(CommandContext ctx, [RemainingText] string Inputname)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                if (Inputname != null)
        ...
        [Command("verif")]
        public async Task VerUser(CommandContext ctx, string type)
        {
            if (ctx.User.Id != 470203136771096596)
            {
