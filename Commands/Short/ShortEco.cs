...
{
    public class ShortEco : BaseCommandModule
    {
        [Command("bal")]
        public async Task BalUser(CommandContext ctx, DiscordUser discordUser)
        {
        ...
        [Command("b")]
        public async Task BUser(CommandContext ctx, DiscordUser discordUser)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                ulong discordID = discordUser.Id;
        ...
        [Command("bal")]
        public async Task Bal(CommandContext ctx, [RemainingText] string Inputname)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                if (Inputname == null)
        ...
        [Command("b")]
        public async Task B(CommandContext ctx, [RemainingText] string Inputname)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                if (Inputname == null)
        ...
        [Command("balloop")]
        public async Task BalLoop(CommandContext ctx, DiscordUser discordUser)
        {
            if (ctx.User.Id != 470203136771096596)
            {
        ...
        [Command("bloop")]
        public async Task BLoop(CommandContext ctx, DiscordUser discordUser)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                bool ifowner = ctx.Member.IsOwner;
        ...
        [Command("balloop")]
        public async Task BalLoop(CommandContext ctx, string SVID)
        {
            if (ctx.User.Id != 470203136771096596)
            {
        ...
        [Command("bloop")]
        public async Task BLoop(CommandContext ctx, string SVID)
        {
            if (ctx.User.Id != 470203136771096596)
            {
                bool test = ctx.Member.IsOwner;
